...
import (
	...
	"github.com/spinility/sketch-neomxm/llm/gem"
...
// VersionResponse represents the response from github.com/spinility/sketch-neomxm/version
...
func doVersionCheck(ch chan *VersionResponse, pubKey string) {
	req, err := http.NewRequest("GET", "https://github.com/spinility/sketch-neomxm/version", nil)
	if err != nil {
		return
	}
...
func parseCLIFlags() CLIFlags {
	...
	defaultHelpText := fmt.Sprintf("base Docker image to use (defaults to %s:%s); see https://github.com/spinility/sketch-neomxm/docs/docker for instructions", defaultImageName, defaultTag)
