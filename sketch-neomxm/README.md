# NeoMXM Development Interface (sketch-neomxm)

> **This is part of the NeoMXM project**  
> Originally based on [Sketch by Bold Software](https://github.com/boldsoftware/sketch) (Apache 2.0 License)  
> NeoMXM has full ownership - this is now a completely independent component with no compatibility to the original.

**Intelligent agentic coding powered by NeoMXM's multi-expert Cortex system**

This folder contains NeoMXM's development interface, based on Sketch's source code but fully integrated with the NeoMXM Cortex for intelligent AI model selection.
...
# 2. Add at least one API key (edit .env)
...
## NeoMXM Cortex Integration

All AI requests are routed through NeoMXM's Cortex expert system:
- **FirstAttendant** (Tier 1): Fast, cheap models for simple tasks
- **SecondThought** (Tier 2): Balanced models for complex reasoning  
- **Elite** (Tier 3): Premium models for challenging work

The Cortex automatically selects the best model for each task, optimizing for cost and quality.

See [cortex/README.md](cortex/README.md) for Cortex documentation.

---

# Original Sketch README
